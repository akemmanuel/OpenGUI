...
const SUPPORTED_LANGUAGE_LOADERS: Record<string, { canonical: string; load: LanguageLoader }> = {
  ts: {
    ...
    <>
      ...
      {html ? (
        <div
          ...
          className="overflow-x-auto p-3 text-sm [font-size:var(--code-font-size)] [&_code]:[font-size:var(--code-font-size)] [&_pre]:[font-size:var(--code-font-size)] [&>pre]:!bg-transparent [&>pre]:!p-0 [&>pre]:!m-0"
        ...
        <pre
          data-code-block-body
          className="overflow-x-auto p-3 text-sm [font-size:var(--code-font-size)] bg-transparent"
        >
          <code>{code}</code>
        </pre>
      )}
