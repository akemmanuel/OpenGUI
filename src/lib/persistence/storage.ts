import type { SettingsBridgeChange } from "@/types/settings";
...
function mirrorValue(key: string, value: string | null): void {
  if (value === null) {
...
function mirrorSettingsToLocalStorage(entries: SettingsCache): void {
