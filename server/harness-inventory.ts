...
const BINARY_BY_HARNESS: Record<HarnessId, string> = {
  opencode: "opencode",
  "claude-code": "claude",
  pi: "pi",
  codex: "codex",
...
export function getHarnessInventory(harnessId: HarnessId): HarnessInventory {
  ...
  return {
    ...
    models: [],
    agents: [],
    message: `${LABEL_BY_HARNESS[harnessId]} was found at ${basename(cli.resolvedPath)}, but OpenGUI has not discovered runtime models from it yet.`,
    checkedAt,
    diagnostics: { cli },
  };
}
