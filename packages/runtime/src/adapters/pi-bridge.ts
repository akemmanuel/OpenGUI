...
function buildTranscriptFromSessionManager(sessionManager: PiSessionManagerLike, directory: string) {
...
export class PiBridgeManager {
  ...
  setSessionActivity(
    ...
    sessionId: string,
    nextType: string,
    { emitEvent = true, preserveAbort = false }: { emitEvent?: boolean; preserveAbort?: boolean } = {},
  ) {
